<!-- add_advantages_disadvantages_modal.php -->
<div id="addAdvantagesDisadvantagesModal" class="modal">
    <form method="POST">
        <h3>Adicionar Vantagens e Desvantagens</h3>
        ...
        <button type="submit" name="add_advantages_disadvantages" class="w-full bg-green-800 text-white p-2 rounded">Adicionar</button>
    </form>
</div>