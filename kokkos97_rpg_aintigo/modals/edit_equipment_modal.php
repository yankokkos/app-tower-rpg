<!-- edit_equipment_modal.php -->
<div id="editEquipmentModal" class="modal">
    <form method="POST">
        <h3>Editar Equipamentos</h3>
        ...
        <button type="submit" name="edit_equipment" class="w-full bg-green-800 text-white p-2 rounded">Salvar</button>
    </form>
</div>